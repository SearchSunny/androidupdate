package com.android_update.error;
...
public class UpdateError extends Throwable {
    ...
    public static final int CHECK_URL = 2007;
    public static final int CHECK_SDCARD = 2008;
    ...
    static {
        ...
        messages.append(CHECK_URL,"url地址错误");
        messages.append(CHECK_SDCARD,"无SDCard");
